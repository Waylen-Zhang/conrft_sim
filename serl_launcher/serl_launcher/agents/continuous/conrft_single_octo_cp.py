...
from octo.model.octo_module import OctoResizeAdapter
...
class ConrftCPOctoAgentSingleArm(flax.struct.PyTreeNode):
    ...
    def create_pixels(
        ...
        **kwargs,
        ...
        real_transformer = octo_model.module.octo_transformer
        # adapter_module = OctoResizeAdapter(octo_transformer=real_transformer)

        actor_encoder_def = OctoEncodingWrapper(
            encoder=real_transformer,
            use_proprio=use_proprio,
            enable_stacking=True,
        )
